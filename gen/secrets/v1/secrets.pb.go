...
const file_secrets_v1_secrets_proto_rawDesc = "" +
	...
	"\x06Delete\x12\x19.secrets.v1.DeleteRequest\x1a\x1a.secrets.v1.DeleteResponseB\x9a\x01\n" +
	"\x0ecom.secrets.v1B\fSecretsProtoP\x01Z1github.com/ogen-app/ogen/gen/secrets/v1;secretsv1\xa2\x02\x03SXX\xaa\x02\n" +
	"Secrets.V1\xca\x02\n" +
