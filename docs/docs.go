                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/secrets.Metadata"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/secrets/{name}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Secret name (allowlisted)",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.secretPutRequest"
                        }
                    }
                ],
                "responses": {
