...
func TestAllWorkersSelfRegister(t *testing.T) {
	const wantWorkers = 15 // submit, poll, cancel, cleanup, reconcile, analytics, followers, bootstrap-profile, process-pdf, process-url, send-email, cleanup-email-logs, cleanup-connect-sessions, detect-expiring-connections, cleanup-notifications
