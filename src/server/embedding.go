...
func initEmbedding(ctx context.Context, cfg *config.Config, repo repository.AssetsEmbeddingsRepository) (func(assetID, title, content string), ai.Embedder, error) {
